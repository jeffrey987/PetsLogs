	...
	<view>
			...
			<view class="u-demo-block">
				...
				<view class="u-demo-block__content" style="margin-top:15px;" >
					<u-row customStyle="margin-bottom: 10px">
						<u-col span="4">
							<u--image src="/static/avater.png" width="80px" height="80px"
								shape="circle"></u--image>
						</u-col>
						<u-col span="8">
							<u-row>
								<u-col span="6">
									<view class=""><strong>123</strong> </view>
								</u-col>
							</u-row>
							<u-row class="font10 fontcolor1">
								<u-col span="4">
									<view class=" ">中华田园犬</view>
								</u-col>
								<u-col span="4">
									<view class=" ">补充年龄</view>
								</u-col>
								<u-col span="4">
									<view class=" ">补充体重</view>
								</u-col>
							</u-row>
						</u-col>
					</u-row>
					<u-row class="div-daojia">
						<u-col>
							<view class="home-date" style="background-color: #F6F2DE;	padding: 10px 0px 10px 10px;border-radius: 10px;">
								补充宠物到家日期</view>
						</u-col>
					</u-row>
				</view>
		...
		<view class="quick-settings">
			<u-row>
				...
				<u-col span="4">
					<u-button type="primary" shape="circle" text="去设置"></u-button>
				</u-col>
			</u-row>
		</view>
		<!-- 记录列表  start-->
		<view class="div-list-log">
			<u-list>
...
<script>
	import Service from '@/api/hppt.js';
	export default {
		data() {
			return {
				indexList: [{
		...
		methods: {
			...
			click2(item) {
				...
				Service.get("https://baidu.com/").then();
			}
		},
